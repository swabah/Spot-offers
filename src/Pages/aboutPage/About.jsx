...
function About() {
  return (
    <div id='About' style={{backgroundImage: `url(${aboutbg})`}} className='flex flex-col w-full h-auto xl:h-screen bg-cover py-12 md:py-12 xl:py-20 pb-5 relative lg:pb-12 bg-no-repeat bg-center items-start   px-3 md:px-10 lg:px-10 xl:px-32'>
      <div className='z-10 w-full h-full text-white'>
        <div className='w-full py-5 md:pt-10 xl:pt-24 flex flex-col text-center items-center justify-center relative'>
            <h2 className='text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-semibold tracking-wide  bg-clip-text bg-gradient-to-r from-[#114193] via-[#055697] to-[#114193] text-transparent drop-shadow-md'>`OFERGRAM`</h2>
            <div className='text-xs md:text-sm  flex items-center space-x-1.5  text-slate-400'>
              <span>Powerd by  | </span> 
              <a href='https://github.com/Spot-Offers' className='flex items-center space-x-1.5 hover:brightness-125'>
              <span className='text-white opacity-80'>Spot-offers</span> 
        ...
        <div className='w-full flex flex-wrap items-center justify-center gap-3 mg:gap-4 xl:space-y-0 xl:justify-between xl:gap-3 h-auto py-8 lg:pt-20 lg:pb-10 xl:px-10 bg-transarent'>
          ...
          <div className=' space-x-1.5  w-auto border border-[#dddddd76] bg-transparent hover:bg-[#dddddd1d] shadow-sm tracking-wide h-auto p-1.5 px-4 rounded-full flex items-center justify-center'>
            ...
            <p className='text-xs   lg:text-sm xl:text-lg capitalize tracking-wider w-full  indent-8 text-center opacity-70'>
